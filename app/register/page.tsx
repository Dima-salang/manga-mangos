...
export default function RegisterPage() {
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 relative overflow-hidden bg-background">
      ...
      <div className="absolute -top-48 -left-48 w-96 h-96 bg-mango/10 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute -bottom-48 -right-48 w-96 h-96 bg-mango/5 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="z-10 flex flex-col items-center">
        ...
        <div className="mt-12 opacity-5 select-none pointer-events-none flex flex-col items-center gap-2">
          <div className="text-sm font-black tracking-[1em] uppercase">MANGOS_SYSTEM</div>
