    ...
    <div className="min-h-screen bg-background relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <ul className="flex gap-8 font-bold text-xs uppercase tracking-widest text-muted-foreground">
              <li><Link href="/browse" className="text-primary">Browse</Link></li>
      ...
      <main className="max-w-7xl mx-auto px-4 py-12 relative z-10">
        <h1 className="text-4xl font-black italic uppercase tracking-tight mb-4">
          <span className="text-mango">/</span> Browse
        </h1>
        <p className="text-muted-foreground">Browse manga — more content coming soon.</p>
      </main>
    </div>
  );
}
